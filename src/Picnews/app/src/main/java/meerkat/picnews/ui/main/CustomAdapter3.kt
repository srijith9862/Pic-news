...
class CustomAdapter3(it:LinkedHashMap<String, HashMap<String, NewsArticle>>,
                     mainActivity: MainActivity,
                     recyclerView: RecyclerView,
                     clickListener: View.OnClickListener) : RecyclerView.Adapter<CustomAdapter3.ViewHolder>()/*,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(holder.adapterPosition == 0){
            holder.titleText.text = "NDTV News"
        }
        if(holder.adapterPosition == 1){
            holder.titleText.text = "Hindustan News"
        }
        if(holder.adapterPosition == 2){
            holder.titleText.text = "news18 News"
        }
